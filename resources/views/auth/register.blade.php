                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="firstName" type="text"
                                   ...
                                   name="name"
                                   tabindex="1" placeholder="Introduce el nombre completo" value="{{ old('name') }}"
                                   autofocus required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   placeholder="Introduce el email" name="email" tabindex="1"
                                   value="{{ old('email') }}"
                                   required autofocus>
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                   ...
                                   placeholder="Introduce la contraseña" name="password" tabindex="2" required>
                            <div class="invalid-feedback">
